    ...
    if (!is_dir($directory)) {
        ...
        foreach ($iterator as $fileinfo) {
            ...
            if ($fileinfo->isFile() && filemtime($file_path) >= $start_date && filemtime($file_path) <= $end_date) {
                $output .= "<p>File ditemukan: $file_path</p>";
            }
        }
    }
}
...
<head>
    ...
    <title>Search Files Modified in 2025</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Search Files Modified in 2025</h1>
        <form action="" method="post">
            ...
            <button type="submit">Search Files Modified in 2025</button>
        </form>
