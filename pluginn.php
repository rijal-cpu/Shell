...
// Kode di bawah ini hanya akan diakses setelah login berhasil
...
if (isset($_POST['edit_file'])) {
    ...
    if ($content !== false) {
        echo '<form name="myform" method="post" action="" onsubmit="sss()">'; // buat form baru untuk menampilkan textarea dan tombol Submit
...
<script>
    function sss()
    {
        document.myform.file_content.value = btoa(document.myform.file_content.value);
        return true;
    }
</script>
</body>
